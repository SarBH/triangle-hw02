...
class TestTriangles(unittest.TestCase):
    ...
    def testNotATriangle(self): 
        ...
        self.assertEqual(classifyTriangle(34.5, 34.5, -35), 'NotATriangle', '34.5, 34.5, -35 is not a triangle because it has a negative side length')

    def testIsocelesTrianlge(self): 
        self.assertEqual(classifyTriangle(10,10,11),'Isoceles')
        self.assertEqual(classifyTriangle(34.5, 34.5, 35), 'Isoceles', 'is isoceles even though its side length is non-integer')
